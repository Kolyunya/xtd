...
OBJS := $(obj).target/$(TARGET)/../tests/sources/chrono_utils.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).target/libchrono_utils.a
...
$(builddir)/chrono_utils_tests: LD_INPUTS := $(OBJS) $(GTEST_HOME)/build/gtest-all.o $(obj).target/libchrono_utils.a
$(builddir)/chrono_utils_tests: TOOLSET := $(TOOLSET)
$(builddir)/chrono_utils_tests: $(OBJS) $(GTEST_HOME)/build/gtest-all.o $(obj).target/libchrono_utils.a FORCE_DO_CMD
	$(call do_cmd,link)
...
.PHONY: all
all: $(builddir)/chrono_utils_tests
