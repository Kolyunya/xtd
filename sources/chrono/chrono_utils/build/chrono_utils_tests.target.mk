...
OBJS := $(obj).target/$(TARGET)/../../../chrono/chrono_utils/sources/chrono_utils.o \
	$(obj).target/$(TARGET)/../../../chrono/chrono_utils/tests/sources/chrono_utils.o
...
$(builddir)/chrono_utils_tests: LD_INPUTS := $(OBJS) $(GTEST_HOME)/build/gtest-all.o
$(builddir)/chrono_utils_tests: TOOLSET := $(TOOLSET)
$(builddir)/chrono_utils_tests: $(OBJS) $(GTEST_HOME)/build/gtest-all.o FORCE_DO_CMD
	$(call do_cmd,link)
