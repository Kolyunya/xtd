...
OBJS := $(obj).target/$(TARGET)/../../../file/file_utils/sources/file_utils.o \
	$(obj).target/$(TARGET)/../../../file/file_utils/tests/sources/file_utils.o
...
$(builddir)/file_utils_tests: LD_INPUTS := $(OBJS) $(GTEST_HOME)/build/gtest-all.o
$(builddir)/file_utils_tests: TOOLSET := $(TOOLSET)
$(builddir)/file_utils_tests: $(OBJS) $(GTEST_HOME)/build/gtest-all.o FORCE_DO_CMD
	$(call do_cmd,link)
