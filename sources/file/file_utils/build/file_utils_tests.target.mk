...
OBJS := $(obj).target/$(TARGET)/../../../file/file_utils/tests/sources/file_utils.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).target/../../../file/file_utils/build/libfile_utils.a
...
$(builddir)/file_utils_tests: LD_INPUTS := $(OBJS) $(GTEST_HOME)/build/gtest-all.o $(obj).target/../../../file/file_utils/build/libfile_utils.a
$(builddir)/file_utils_tests: TOOLSET := $(TOOLSET)
$(builddir)/file_utils_tests: $(OBJS) $(GTEST_HOME)/build/gtest-all.o $(obj).target/../../../file/file_utils/build/libfile_utils.a FORCE_DO_CMD
	$(call do_cmd,link)
