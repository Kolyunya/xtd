...
namespace xtd
{
    ...
    signed long long int str::to_long_long ( const std::string& source_string , signed int number_base )
    {
        ...
        if ( number == 0 )
        {
            ...
            {
                throw std::runtime_error(str::error_string_to_number_conversion_failed);
            }
        }
        ...
        {
            throw std::runtime_error(str::error_number_exceeds_type_limits);
        }
    ...
    signed long int str::to_long ( const std::string& source_string , signed int number_base )
    {
    ...
    signed int str::to_int ( const std::string& source_string , signed int number_base )
    {

        //  Try to convert the string to "signed long int"
        signed long int number = str::to_long(source_string,number_base);
    ...
    long double str::to_long_double ( const std::string& source_string )
    {
    ...
    double str::to_double ( const std::string& source_string )
    {
    ...
    float str::to_float ( const std::string& source_string )
    {
    ...
    std::string str::reverse ( const std::string& source_string )
    {
    ...
    str::strings str::split ( const std::string& source_string , const std::string& delimiter )
    {
        ...
        if ( string_size > 0 )
        {
            ...
            else
            {
                ...
                str::strings string_reminder_split = split(string_tail,delimiter);
    ...
    str::strings str::split ( const std::string& source_string , char delimiter )
    {
        std::string delimiter_string = std::string(1,delimiter);
        str::strings result_strings = split(source_string,delimiter_string);
        return result_strings;
    }

    std::string str::replace ( const std::string& source_string , const std::string& search_for , const std::string& replace_with )
    {
    ...
    std::string str::replace ( const std::string& source_string , const char search_for , const char replace_with )
    {
    ...
    bool str::is_numeric ( const std::string& source_string )
    {
    ...
    bool str::is_integer ( const std::string& source_string )
    {
    ...
    bool str::is_fractional ( const std::string& source_string )
    {
        bool source_is_numeric = is_numeric(source_string);
        bool source_string_is_not_numeric = ! source_is_numeric;
        if ( source_string_is_not_numeric )
    ...
    const char* str::error_string_to_number_conversion_failed = "String to number conversion failed.";

    const char* str::error_number_exceeds_type_limits = "Number exceeds type limits.";
