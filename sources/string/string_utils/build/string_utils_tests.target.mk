...
OBJS := $(obj).target/$(TARGET)/../sources/string/string_utils/tests/sources/string_utils.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).target/../sources/string/string_utils/build/libstring_utils.a
...
$(builddir)/string_utils_tests: LD_INPUTS := $(OBJS) $(GTEST_HOME)/build/gtest-all.o $(obj).target/../sources/string/string_utils/build/libstring_utils.a
$(builddir)/string_utils_tests: TOOLSET := $(TOOLSET)
$(builddir)/string_utils_tests: $(OBJS) $(GTEST_HOME)/build/gtest-all.o $(obj).target/../sources/string/string_utils/build/libstring_utils.a FORCE_DO_CMD
	$(call do_cmd,link)
