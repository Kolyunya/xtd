...
OBJS := $(obj).target/$(TARGET)/../sources/string_utils.o \
	$(obj).target/$(TARGET)/../tests/sources/string_utils.o
...
$(builddir)/string_utils_tests: LD_INPUTS := $(OBJS) $(GTEST_HOME)/build/gtest-all.o
$(builddir)/string_utils_tests: TOOLSET := $(TOOLSET)
$(builddir)/string_utils_tests: $(OBJS) $(GTEST_HOME)/build/gtest-all.o FORCE_DO_CMD
	$(call do_cmd,link)
